...
<div
    ...
    <div class="w-full px-3 sm:px-4 lg:px-6">
        <div x-show="show"
            ...
            <form method="GET" action="<?php echo e(route('stock.index')); ?>"
                ...
                <div class="relative col-span-2 sm:col-span-1 sm:w-52">
                    <select name="crosshead_type"
                        ...
                        <?php $__currentLoopData = $crossheadTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type); ?>" <?php echo e(request('crosshead_type')==$type ? 'selected':''); ?>><?php echo e($type); ?></option>
                ...
                <div class="relative col-span-2 sm:col-span-1 sm:w-52">
                    <select name="dies_type"
                        ...
                        <?php $__currentLoopData = $diesTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type); ?>" <?php echo e(request('dies_type')==$type ? 'selected':''); ?>><?php echo e($type); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <svg class="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.18l3.71-3.95a.75.75 0 111.08 1.04l-4.25 4.52a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                ...
                <?php if(request()->has('crosshead_type') || request()->has('dies_type')): ?>
    ...
    <div class="w-full px-2 sm:px-3 lg:px-4">
        <div class="overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm">
            <table class="w-full min-w-[1100px] text-[13px] sm:text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $stockDies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <tr class="hover:bg-slate-50/60 cursor-pointer"
                        data-row="<?php echo e($dies->id); ?>"
                        @click="
                          openEdit = true;
                          $refs.editTitle.textContent = 'Edit Stock #<?php echo e($dies->id); ?> — <?php echo e($dies->dies_code); ?>';
                          $refs.editBody.innerHTML   = $refs['tpl<?php echo e($dies->id); ?>'].innerHTML;
                        ">
                        <td class="px-3 sm:px-4 py-3 text-slate-700" data-field="id"><?php echo e($dies->id); ?></td>
                        <td class="px-3 sm:px-4 py-3 font-semibold text-slate-900" data-field="dies_code"><?php echo e($dies->dies_code); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="dies_diameter"><?php echo e(number_format((float)$dies->dies_diameter,2)); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="dies_type">
                            <span class="inline-flex rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-700"><?php echo e($dies->dies_type); ?></span>
                        </td>
                        <td class="px-3 sm:px-4 py-3" data-field="position">
                            <span class="inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold <?php echo e($posClass); ?>"><?php echo e($dies->position ?? '-'); ?></span>
                        </td>
                        <td class="px-3 sm:px-4 py-3" data-field="crosshead_type">
                            <span class="inline-flex rounded-full bg-sky-50 px-2.5 py-0.5 text-xs font-medium text-sky-700"><?php echo e($dies->crosshead_type); ?></span>
                        </td>
                        <td class="px-3 sm:px-4 py-3" data-field="material">
                            <?php if($matName): ?>
                            <span class="inline-flex rounded-full bg-violet-50 px-2.5 py-0.5 text-xs font-medium text-violet-700"><?php echo e($matName); ?></span>
                            <span class="ml-1 text-xs text-slate-400">#<?php echo e($dies->material_id); ?></span>
                            <?php else: ?>
                            <span class="text-slate-700">#<?php echo e($dies->material_id ?? '-'); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="px-3 sm:px-4 py-3" data-field="material_dies">
                            <span class="inline-flex rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-700"><?php echo e($dies->material_dies ?? 'stavac'); ?></span>
                        </td>
                        <td class="px-3 sm:px-4 py-3" data-field="ordered_by"><?php echo e($dies->ordered_by ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="supplier"><?php echo e($dies->supplier ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="arrival_date"><?php echo e(optional($dies->arrival_date)->format('Y-m-d') ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="condition"><?php echo e($dies->condition ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="checked_by"><?php echo e($dies->checked_by ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3" data-field="checked_date"><?php echo e(optional($dies->checked_date)->format('Y-m-d') ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3 text-slate-500" data-field="created_at"><?php echo e(optional($dies->created_at)->format('Y-m-d H:i:s') ?? '-'); ?></td>
                        <td class="px-3 sm:px-4 py-3 text-slate-500" data-field="updated_at"><?php echo e(optional($dies->updated_at)->format('Y-m-d H:i:s') ?? '-'); ?></td>
                    </tr>

                    
                    <template x-ref="tpl<?php echo e($dies->id); ?>">
                        <form method="POST" action="<?php echo e(route('stock.update',$dies->id)); ?>" data-id="<?php echo e($dies->id); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="dies_code" value="<?php echo e($dies->dies_code); ?>" required
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="dies_diameter" value="<?php echo e(number_format((float)$dies->dies_diameter,2,'.','')); ?>" required
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="dies_type"
                                        ...
                                        <?php $__currentLoopData = $diesTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type); ?>" <?php echo e($dies->dies_type===$type?'selected':''); ?>><?php echo e($type); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="position"
                                        class="w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 pr-10 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                        <option value="core" <?php echo e($dies->position==='core'?'selected':''); ?>>core</option>
                                        <option value="ring" <?php echo e($dies->position==='ring'?'selected':''); ?>>ring</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="crosshead_type"
                                        class="w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 pr-10 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                        <?php $__currentLoopData = $crossheadTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type); ?>" <?php echo e($dies->crosshead_type===$type?'selected':''); ?>><?php echo e($type); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="material_id"
                                        ...
                                        <option value="<?php echo e($m->id); ?>" <?php echo e((int)$dies->material_id===(int)$m->id?'selected':''); ?>><?php echo e($m->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="material_dies" value="<?php echo e($dies->material_dies); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>

                                <div>
                                    <label class="block text-xs font-medium text-slate-600 mb-1">Ordered By</label>
                                    <input type="text" name="ordered_by" value="<?php echo e($dies->ordered_by); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>

                                <div>
                                    <label class="block text-xs font-medium text-slate-600 mb-1">Supplier</label>
                                    <input type="text" name="supplier" value="<?php echo e($dies->supplier); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="arrival_date"
                                        value="<?php echo e(optional($dies->arrival_date)->timezone('Asia/Jakarta')->format('Y-m-d')); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>

                                <div>
                                    <label class="block text-xs font-medium text-slate-600 mb-1">Condition</label>
                                    <input type="text" name="condition" value="<?php echo e($dies->condition); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>

                                <div>
                                    <label class="block text-xs font-medium text-slate-600 mb-1">Checked By</label>
                                    <input type="text" name="checked_by" value="<?php echo e($dies->checked_by); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="checked_date"
                                        value="<?php echo e(optional($dies->checked_date)->timezone('Asia/Jakarta')->format('Y-m-d')); ?>"
                                        class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </form>
        ...
        <div class="py-4">
            <?php echo e($stockDies->withQueryString()->links()); ?>
    ...
    <div x-cloak x-show="openCreate" x-transition.opacity
        ...
        <div class="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden
            ...
            <form method="POST" action="<?php echo e(route('stock.store')); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Dies Code</label>
                            <input type="text" name="dies_code" value="<?php echo e(old('dies_code')); ?>" required
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Diameter (mm)</label>
                            <input type="number" step="0.01" name="dies_diameter" value="<?php echo e(old('dies_diameter')); ?>" required
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Dies Type</label>
                            <select name="dies_type"
                                ...
                                <?php $__currentLoopData = $diesTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type); ?>" <?php if(old('dies_type')===$type): echo 'selected'; endif; ?>><?php echo e($type); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="position"
                                class="w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 pr-10 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="core" <?php if(old('position')==='core' ): echo 'selected'; endif; ?>>core</option>
                                <option value="ring" <?php if(old('position')==='ring' ): echo 'selected'; endif; ?>>ring</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Crosshead Type</label>
                            <select name="crosshead_type"
                                ...
                                <?php $__currentLoopData = $crossheadTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type); ?>" <?php if(old('crosshead_type')===$type): echo 'selected'; endif; ?>><?php echo e($type); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="material_id"
                                ...
                                <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m->id); ?>" <?php if(old('material_id')==$m->id): echo 'selected'; endif; ?>><?php echo e($m->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Material Dies</label>
                            <input type="text" name="material_dies" value="<?php echo e(old('material_dies')); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Ordered By</label>
                            <input type="text" name="ordered_by" value="<?php echo e(old('ordered_by')); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Supplier</label>
                            <input type="text" name="supplier" value="<?php echo e(old('supplier')); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Arrival Date</label>
                            <input type="date" name="arrival_date"
                                value="<?php echo e(old('arrival_date', now('Asia/Jakarta')->format('Y-m-d'))); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Condition</label>
                            <input type="text" name="condition" value="<?php echo e(old('condition')); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Checked By</label>
                            <input type="text" name="checked_by" value="<?php echo e(old('checked_by')); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-slate-600 mb-1">Checked Date</label>
                            <input type="date" name="checked_date"
                                value="<?php echo e(old('checked_date', now('Asia/Jakarta')->format('Y-m-d'))); ?>"
                                class="w-full rounded-xl border border-slate-300 px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\cablejacketing\jacketing-kabel\resources\views/stock/index.blade.php ENDPATH**/ ?>