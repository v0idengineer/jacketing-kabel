...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('logoapp.png')); ?>">
    <title><?php echo e($title ?? 'RnD Jacketing'); ?></title>
</head>
    ...
    <header class="md:hidden sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-slate-200">
        <div class="px-4 h-14 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <img src="<?php echo e(asset('logoapp.png')); ?>" alt="Logo" class="h-8 w-8 rounded object-contain">
        ...
        <div x-show="mobileMenu" x-cloak
            ...
            <nav class="px-2 py-2 space-y-1">
                ...
                <a href="<?php echo e(route($it['route'])); ?>"
                    @click="mobileMenu=false"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg
                              <?php echo e(request()->routeIs($it['route']) ? 'bg-slate-900 text-white' : 'text-slate-700 hover:bg-slate-50'); ?>">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($it['icon']); ?>" />
                    </svg>
            ...
            <div class="px-2 pb-3 pt-2 border-t border-slate-200">
                <div class="px-3 py-2">
                    <p class="text-sm font-semibold text-slate-900 break-words"><?php echo e(Auth::user()->name); ?></p>
                    <p class="text-xs text-slate-500 break-words"><?php echo e(Auth::user()->email); ?></p>
                </div>
            ...
            <nav class="flex-1 py-2">
                ...
                <div x-data="{h:false}" @mouseenter="h=true" @mouseleave="h=false" class="relative">
                    <a href="<?php echo e(route($it['route'])); ?>"
                        ...
                        <span x-show="open" x-cloak class="font-medium"><?php echo e($it['label']); ?></span>
                    </a>
...
</html><?php /**PATH D:\cablejacketing\jacketing-kabel\resources\views/layouts/app.blade.php ENDPATH**/ ?>