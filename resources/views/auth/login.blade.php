...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('logoapp.png') }}">
</head>
...
<body class="min-h-screen bg-gradient-to-br from-indigo-600 via-sky-500 to-emerald-400 flex items-center justify-center p-4 sm:p-6">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="mb-6 flex items-center justify-center gap-3">
            <img src="{{ asset('logoapp.png') }}" alt="Logo" class="h-10 w-10 rounded object-contain">
        ...
        <!-- Footnote -->
        <p class="mt-4 text-center text-xs text-white/80">© {{ date('Y') }} RnD Jacketing • Internal</p>
    </div>
